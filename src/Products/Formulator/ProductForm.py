...
class ProductForm(BasicForm):
    ...
    def addField(self, field_id, fieldType, group=None, **kwargs):
        ...
        field_id: Name of the variable in question.  Note that Formulator adds
            'field_' to variable names, so you will need to refer to the
            variable foo as field_foo in form page templates.
        ...
        # Note: This messes with Formulator innards and may break in the
        # future.
    ...
    def validate(self, REQUEST, errors=None):
        """
        Executes the validator for each field in the wrapped
        BasicForm.add_field
